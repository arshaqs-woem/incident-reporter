  ...
  return [
    { toolName: 'hangUp' },
    {
      temporaryTool: {
        ...
        http: {
          baseUrlPattern: `${PUBLIC_URL}/api/tools/report-incident?callId=${cid}`,
          httpMethod: 'POST'
        }
      }
    },
    {
      temporaryTool: {
        ...
        http: {
          baseUrlPattern: `${PUBLIC_URL}/api/tools/check-previous-incidents?callId=${cid}`,
          httpMethod: 'POST'
        }
      }
    },
    {
      temporaryTool: {
        ...
        http: {
          baseUrlPattern: `${PUBLIC_URL}/api/tools/get-contacts?callId=${cid}`,
          httpMethod: 'POST'
        }
      }
    }
